...
* Fixed a bug in the `jscripts.php` file that affects PHP 5.4 and below.
...
* Fixed a bug in the `jscripts.php` file that affects PHP 5.4 and below, and updated the anti spam filters. Please see Changelog for details.
